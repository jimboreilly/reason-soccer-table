...
function formatRecordRow(position, r) {
  return React.createElement("tr", undefined, React.createElement("td", undefined, String(position + 1 | 0)), React.createElement("td", undefined, r.name), React.createElement("td", undefined, String((r.wins + r.draws | 0) + r.losses | 0)), React.createElement("td", undefined, String(r.wins)), React.createElement("td", undefined, String(r.draws)), React.createElement("td", undefined, String(r.losses)), React.createElement("td", undefined, String(calculatePoints(r))), React.createElement("td", undefined, String(r.goalsFor)), React.createElement("td", undefined, String(r.goalsAgainst)), React.createElement("td", undefined, String(r.goalsFor - r.goalsAgainst | 0)));
}

function Table(Props) {
  var records = Props.records;
  return React.createElement("div", undefined, React.createElement("table", undefined, tableHeader(undefined), $$Array.of_list(List.mapi(formatRecordRow, records))));
}
